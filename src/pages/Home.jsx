...
const Home = () => {
    return (
        <div className='mnPage'>
            ...
            <h2>Our Mission:</h2>
            <p className='mission'>To provide quality education to people in all varietes of subjects. To not make false promises and mislead you. Lastly, to keep you the customer happy.</p>
