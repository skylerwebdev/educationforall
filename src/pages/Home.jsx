  ...
  const [state, setState] = useState()
    ...
    return (
        <div className='mnPg'>
            ...
            <div className="mnHdr">
            <h1>FREE CLASS</h1>
            <h1 className='mnHdr hmHdrH1'>20 People needed by this Monday</h1>
            <h5 className="mnSubHdr SH2">I would like to start small coding and development classes</h5>
            <p>I need 25-30 people to check out this course for free! This course would be great for anyone interested in the development world. There are a lot of coding bootcamps if you have ever thought about going to one this is the class for you! Once you are done you will not question it anymore.</p>
